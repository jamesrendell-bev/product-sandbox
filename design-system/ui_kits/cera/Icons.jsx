...
const P = {
  ...
  analysis: <><line x1="12" x2="12" y1="20" y2="10"/><line x1="18" x2="18" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="14"/></>,
  archive: <><line x1="8" x2="21" y1="6" y2="6"/><line x1="8" x2="21" y1="12" y2="12"/><line x1="8" x2="21" y1="18" y2="18"/><line x1="3.5" x2="3.51" y1="6" y2="6"/><line x1="3.5" x2="3.51" y1="12" y2="12"/><line x1="3.5" x2="3.51" y1="18" y2="18"/></>,
  exposure: <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>,
  hub: <><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/></>,
  ...
  // --- Perils (BEV set) ---
  earthquake: <path d="M2 12h4l2-6 3 12 2-9 2 5h7"/>,
  cyclone: <><circle cx="12" cy="12" r="1.5"/><path d="M13 4c5.5.5 5.5 7 0 8"/><path d="M11 20c-5.5-.5-5.5-7 0-8"/></>,
  ...
  rainfall: <><path d="M4 14.9A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.24"/><path d="M8 16v4"/><path d="M12 18v4"/><path d="M16 16v4"/></>,
  snowfall: <><path d="M4 14.9A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.24"/><path d="M8 16h.01"/><path d="M8 20h.01"/><path d="M12 18h.01"/><path d="M12 22h.01"/><path d="M16 16h.01"/><path d="M16 20h.01"/></>,
  windspeed: <><path d="M3 8h12"/><path d="M3 12h17"/><path d="M3 16h9"/></>,
  windgust: <><path d="M12.8 19.6A2 2 0 1 0 14 16H2"/><path d="M17.5 8a2.5 2.5 0 1 1 2 4H2"/><path d="M9.8 4.4A2 2 0 1 1 11 8H2"/></>,
